...
SECRET_KEY = 't7$@7)9s!hy5v(33^xvm*gc3vkmz$0aoq%6ohqb+!*lpby7=d='
...
# (Optional) Path where collected static files are stored in production
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Ensure the static directory of your app is included
STATICFILES_DIRS = [
